...
public class SyllabusActivityMech extends AppCompatActivity {
    Toolbar toolbar;
    ...
    String syllabusList[] = {"MODULE-I\n" +
            ...
            "Heat & work\n" +
            "work done for different polytropic processes\n" +
            "Zeroth Law and its Application\n" +
            "First law of Thermodynamics\n" +
            "Steay flow energy equations\n" +
            "Application of first law\n" +
            "Limitation of Fist law of Thermodynamics","MODULE-II\n" +
            "Concept of heat engine\n" +
            "heat pump and refrigrator\n" +
            "Second Law Of Thermodynamics\n" +
            "Carnot Theorem\n" +
            "Clausis Inequality\n" +
            "Concept of entropy\n" +
            "Entropy change during various processes\n" +
            "Introcution to 2 stroke and 4 stroke SI engine\n" +
            "Introcution to 2 stroke and 4 stroke CI engine\n" +
            "Introcution hot and cold working processes\n" +
            "Forging\n" +
            "Rolling\n" +
            "Extrusion Types of Pattern and their allowance\n" +
            "Moulding sand and their properties\n" +
            "Concept of gating system","MODULE-III\n" +
            "Working principles and operation of lathe\n" +
            "Grilling machine\n" +
            "Grinding machine\n" +
            "Shaper\n" +
            "Basic principles and Application of arc welding\n" +
            "Gas Welding\n" +
            "Spot Welding\n" +
            "Soldering\n" +
            "Brazing"};
