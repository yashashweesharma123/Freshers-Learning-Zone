...
public class FirstYearPaper extends AppCompatActivity {
    Toolbar toolbar;
    DrawerLayout dLayout;
    ListView listView;
    String syllabusList[] = {"2015-2016:",
            "FIRST SEMESTER",
            "SECOND SEMESTER",
            "2016-2017:",
            "FIRST SEMESTER",
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    ...
                    case 1:
                        Intent intent2=new Intent(FirstYearPaper.this,FirstYearFirstSemester.class);
                        //intent2.putExtra("URL","https://drive.google.com/open?id=13HJr-zQthCyHwUiKzDqxVkNdVGJFY9hk");
                        startActivity(intent2);
                        break;

                    case 2:
                        Intent intent3=new Intent(FirstYearPaper.this,FirstYearSecondSemester.class);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent intent5=new Intent(FirstYearPaper.this,FirstYear3.class);
                        //intent5.putExtra("URL","https://drive.google.com/open?id=1uLr08_lFVxzwjgpRdEhPoN9CQtiH_CTj");
                        startActivity(intent5);
                        break;

                    case 5:
                        Intent intent6=new Intent(FirstYearPaper.this,FirstYear4.class);
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        Intent intent7=new Intent(FirstYearPaper.this,FirstYear5.class);
                        startActivity(intent7);
                        break;
                    case 8:
                        Intent intent8=new Intent(FirstYearPaper.this,FirstYear6.class);
