...
public class ElectronicPaper extends AppCompatActivity {
    Toolbar toolbar;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    ...
                    case 1:
                        Intent intent2=new Intent(ElectronicPaper.this,ElectronicFirstSemester.class);
                        //intent2.putExtra("URL","https://drive.google.com/open?id=13HJr-zQthCyHwUiKzDqxVkNdVGJFY9hk");
                        startActivity(intent2);
                        break;

                    case 2:
                        Intent intent3=new Intent(ElectronicPaper.this,ElectronicSecondSemester.class);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent intent5=new Intent(ElectronicPaper.this,Electronic3.class);
                        //intent5.putExtra("URL","https://drive.google.com/open?id=1uLr08_lFVxzwjgpRdEhPoN9CQtiH_CTj");
                        startActivity(intent5);
                        break;

                    case 5:
                        Intent intent6=new Intent(ElectronicPaper.this,Electronic4.class);
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        Intent intent7=new Intent(ElectronicPaper.this,Electronic5.class);
                        startActivity(intent7);
                        break;
                    case 8:
                        Intent intent8=new Intent(ElectronicPaper.this,Electronic6.class);
