...
public class PolarisationActivity extends AppCompatActivity {
    WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://drive.google.com/open?id=1H0Ku_OZVcdhuUQjbdsOUpmHvuCrXq459");
    ...
    //webView.getSettings().setJavaScriptEnabled(true);
    //String pdf = "https://drive.google.com/open?id=1lcKcBUznMth-_SwgdIQspbIYKuBTwwpb";
    //webView.loadUrl("https://drive.google.com/open?id=1dNIi0_GZwMqfnALSLvmSeb5T2SlqTsmF");
    //webView.loadUrl("https://drive.google.com/file/d/1wrt9hnoX0XfT8Zcwk-lX2gUbav1pljx2/view");
