...
public class PythonQuizActivity extends AppCompatActivity {
    ...
    private ArrayList<PythonQuestions> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private PythonQuestions currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pythonquiz);
        ...
        PythonQuizDbHelper dbHelper = new PythonQuizDbHelper(this);
